...
using ROULETTE.Plugins.External_Pack.Simple_Scroll_Snap.Scripts.Runtime;
using UnityEditor;
using UnityEngine;
using UnityEngine.EventSystems;
using UnityEngine.UI;

namespace ROULETTE.Plugins.External_Pack.Simple_Scroll_Snap.Scripts.Editor
{
    ...
    public class SimpleScrollSnapEditor : UnityEditor.Editor
    {
        ...
        private Runtime.SimpleScrollSnap simpleScrollSnap;
        ...
        {
            simpleScrollSnap = target as Runtime.SimpleScrollSnap;
        ...
        private void MovementType()
        {
            ...
            if (simpleScrollSnap.movementType == Runtime.SimpleScrollSnap.MovementType.Fixed)
            {
        ...
        private void AutomaticLayout()
        {
            ...
            if (simpleScrollSnap.automaticallyLayout)
            {
                ...
                if (simpleScrollSnap.sizeControl == ROULETTE.Plugins.External_Pack.Simple_Scroll_Snap.Scripts.Runtime.SimpleScrollSnap.SizeControl.Manual)
                {
                    EditorGUI.indentLevel++;
        ...
        {
            using (new EditorGUI.DisabledScope(simpleScrollSnap.movementType == Runtime.SimpleScrollSnap.MovementType.Free))
            {
            ...
            if (simpleScrollSnap.movementType == ROULETTE.Plugins.External_Pack.Simple_Scroll_Snap.Scripts.Runtime.SimpleScrollSnap.MovementType.Free)
            {
                simpleScrollSnap.snapTarget = ROULETTE.Plugins.External_Pack.Simple_Scroll_Snap.Scripts.Runtime.SimpleScrollSnap.SnapTarget.Nearest;
            }
        }
        ...
        private static void CreateSimpleScrollSnap()
        {
            ...
            scrollSnap.AddComponent<ROULETTE.Plugins.External_Pack.Simple_Scroll_Snap.Scripts.Runtime.SimpleScrollSnap>();
