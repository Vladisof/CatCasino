...
namespace ROULETTE.Plugins.External_Pack.Simple_Scroll_Snap.Scripts.Runtime
{
    ...
    public class TransitionEffect
    {
        ...
        #region Methods
        public TransitionEffect(string label, float minValue, float maxValue, float minDisplacement, float maxDisplacement, AnimationCurve function, ROULETTE.Plugins.External_Pack.Simple_Scroll_Snap.Scripts.Runtime.SimpleScrollSnap simpleScrollSnap)
        {
            this.label = label;
