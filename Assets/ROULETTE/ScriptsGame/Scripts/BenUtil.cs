...
namespace Cat
{
  ...
  public class BenUtil : MonoBehaviour
  {

    public static BenUtil instance;
    ...
    public static IEnumerator ImageScale (Image img, Color color, float ScaleStart, float ScaleMax, float ScaleEnd, float ScaleTime, float fDelay)
    {
    ...
    public string DateStringChange (string Regdate)
    {
      ...
      if (timeDelta.Days > 0)
        strRankResetLeft = timeDelta.Days.ToString() + "day" + " " + timeDelta.Hours.ToString() + "hoursbefore";
      else if (timeDelta.Hours > 0)
        strRankResetLeft = timeDelta.Hours.ToString() + "hour" + " " + timeDelta.Minutes.ToString() + "minutebefore";
      else if (timeDelta.Minutes > 0)
        strRankResetLeft = timeDelta.Minutes.ToString() + "minute" + " " + timeDelta.Seconds.ToString() + "secondbefore";
      else
        strRankResetLeft = "justbefore";
    ...
    {
      int iCurrent = second;
      int Day = iCurrent / 86400;

      if (Day > 0)
        iCurrent -= Day * 86400;

      int Hour = iCurrent / 3600;
      ...
      if (Day > 0)
        strReturn = Day.ToString() + "D " + Hour.ToString() + "H";
      else if (Hour > 0)
        strReturn = Hour.ToString() + "H " + Min.ToString() + "M";
      else if (Min > 0)
        strReturn = Min.ToString() + "M " + Sec.ToString() + "S";
      else
        strReturn = Sec.ToString() + "S";
