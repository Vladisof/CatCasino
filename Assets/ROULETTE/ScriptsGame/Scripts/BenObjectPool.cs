...
namespace Cat
{
  ...
  public class BenObjectPool : MonoBehaviour
  {

    private static BenObjectPool _instance;
    public static BenObjectPool instance
    {
      get
      {
        if (!_instance)
        {
          _instance = GameObject.FindObjectOfType(typeof(BenObjectPool)) as BenObjectPool;

          if (!_instance)
          {
            GameObject container = new GameObject("ObjectPool");
            _instance = container.AddComponent(typeof(BenObjectPool)) as BenObjectPool;
